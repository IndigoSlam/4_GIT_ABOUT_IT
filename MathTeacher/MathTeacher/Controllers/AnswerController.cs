...
namespace MathTeacher.Controllers
{
    public class AnswerController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,StartTime,EndTIme")] AnswerModel answerModel)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,StartTime,EndTIme")] AnswerModel answerModel)
        {
            if (ModelState.IsValid)
            {
